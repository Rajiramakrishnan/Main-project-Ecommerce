    ...
    <div className='container-fluid footer_wrapper'>
        <div className='row gx-5 footer_row'>
            <div className='col-md-4 col-12 footer_col_1'>
                <img src={img} class="img-fluid img-thumbnail" alt="..."/>SPARKLE  <span>CART</span>
  ...
  <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6"/>
            ...
            <div className='col-md-4 col-6'>
                ...
                <div className='footer_col3_info'>
                    <div><a href="/buyer/profile">My Account</a></div>
                    <div><a href="/">Login</a></div>
                    <div><a href="/cart/:buyerId/">My Cart</a></div>
                    <div><a href="/buyer/wishlist">My Wishlist</a></div>
                    <div><a href="/buyer/orders/">Orders</a></div>
                </div>
            </div>
